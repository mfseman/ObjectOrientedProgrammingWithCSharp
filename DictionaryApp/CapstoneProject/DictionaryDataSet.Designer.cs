...
namespace CapstoneProject {
    ...
    public partial class DictionaryDataSet : global::System.Data.DataSet {
        ...
        public partial class DictionaryDataTable : global::System.Data.TypedTableBase<DictionaryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DictionaryRow AddDictionaryRow(string Name, string Filename, string Description) {
        ...
        public partial class DictionaryRow : global::System.Data.DataRow {
            ...
            public string Filename {
                get {
                    return ((string)(this[this.tableDictionary.FilenameColumn]));
                }
                set {
                    this[this.tableDictionary.FilenameColumn] = value;
                }
            }
            ...
            public string Description {
                get {
                    return ((string)(this[this.tableDictionary.DescriptionColumn]));
                }
                set {
                    this[this.tableDictionary.DescriptionColumn] = value;
                }
            }
...
namespace CapstoneProject.DictionaryDataSetTableAdapters {
    ...
    public partial class DictionaryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Dictionary] WHERE (([ID] = @Original_ID) AND ([Name] = @Origin" +
                "al_Name) AND ([Filename] = @Original_Filename))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Dictionary] ([Name], [Filename], [Description]) VALUES (@Name," +
                " @Filename, @Description);\r\nSELECT ID, Name, Filename, Description FROM Dictiona" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Dictionary] SET [Name] = @Name, [Filename] = @Filename, [Description] = @Description WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Filename] = @Original_Filename));
SELECT ID, Name, Filename, Description FROM Dictionary WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CapstoneProject.Properties.Settings.Default.DictionaryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Filename, Description FROM dbo.Dictionary";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Dictionary\r\nWHERE        (ID = @ID)";
            ...
            this._commandCollection[2].CommandText = "SELECT ID, Name, Filename, Description FROM dbo.Dictionary";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "INSERT INTO [dbo].[Dictionary] ([Name], [Filename], [Description]) VALUES (@Name," +
                " @Filename, @Description);";
            ...
            this._commandCollection[4].CommandText = "UPDATE [dbo].[Dictionary] SET [Name] = @Name, [Filename] = @Filename, [Descriptio" +
                "n] = @Description;";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Filename", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Filename", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int FillBy(DictionaryDataSet.DictionaryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Filename) {
        ...
        public virtual int Insert(string Name, string Filename, string Description) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Filename, string Description, int Original_ID, string Original_Name, string Original_Filename, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        public virtual int InsertQuery(string Name, string Filename, string Description) {
        ...
        public virtual int UpdateQuery(string Name, string Filename, string Description) {
